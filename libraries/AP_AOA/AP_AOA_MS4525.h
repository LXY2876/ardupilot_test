...
class AP_Aoa_MS4525 : public AP_Aoa_Backend
{
public:
    AP_Aoa_MS4525(AP_Aoa &frontend, uint8_t _instance);
    ~AP_Aoa_MS4525(void) {}
    ...
    uint32_t get_connect(void) {return is_founded;}
private:
    void _measure();
    void _collect();
    void _timer();
